...
LEXERS = {
    ...
    'AntlrCppLexer': ('pip._vendor.pygments.lexers.parsers', 'ANTLR With CPP Target', ('antlr-c_cpp',), ('*.G', '*.g'), ()),
    ...
    'CppLexer': ('pip._vendor.pygments.lexers.c_cpp', 'C++', ('c_cpp', 'c++'), ('*.c_cpp', '*.hpp', '*.c++', '*.h++', '*.cc', '*.hh', '*.cxx', '*.hxx', '*.C', '*.H', '*.cp', '*.CPP', '*.tpp'), ('text/x-c++hdr', 'text/x-c++src')),
    'CppObjdumpLexer': ('pip._vendor.pygments.lexers.asm', 'c_cpp-objdump', ('c_cpp-objdump', 'c++-objdumb', 'cxx-objdump'), ('*.c_cpp-objdump', '*.c++-objdump', '*.cxx-objdump'), ('text/x-c_cpp-objdump',)),
    ...
    'RagelCppLexer': ('pip._vendor.pygments.lexers.parsers', 'Ragel in CPP Host', ('ragel-c_cpp',), ('*.rl',), ()),
